...
var TimeModel = mysql_1.default.TimeModel;
TimeModel.fetch = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    r = {};
                    return [4 /*yield*/, TimeModel.findAndCountAll({
                            // 获取所有信息
...
TimeModel.sendComment = function (res, token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    content = res.content;
                    r = {};
                    return [4 /*yield*/, TimeModel.create({
                            // 获取所有信息
                            uid: uid,
                            aid: articleId,
                            comments: content,
