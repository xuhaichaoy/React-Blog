...
var TimesController = /** @class */ (function () {
    function TimesController() {
    }
    TimesController.prototype.getTime = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Time_1.default.fetch()];
                    case 1:
                        r = _a.sent();
                        return [2 /*return*/, {
                                data: r
    ...
    TimesController.prototype.sendComment = function (res, params) {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Time_1.default.sendComment(res, params)];
                    case 1:
                        r = _a.sent();
                        return [2 /*return*/, {
                                data: r
    ...
    TimesController.prototype.put = function (id, user) {
        return "Updating a user...";
    };
    TimesController.prototype.remove = function (id) {
        return "Removing user...";
    };
    __decorate([
        routing_controllers_1.Get("/getTime"),
    ...
    ], TimesController.prototype, "getTime", null);
    __decorate([
